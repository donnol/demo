"".main STEXT size=120 args=0x0 locals=0x48
	0x0000 00000 (main.go:11)	TEXT	"".main(SB), $72-0
	0x0000 00000 (main.go:11)	MOVQ	(TLS), CX
	0x0009 00009 (main.go:11)	CMPQ	SP, 16(CX)
	0x000d 00013 (main.go:11)	JLS	113
	0x000f 00015 (main.go:11)	SUBQ	$72, SP
	0x0013 00019 (main.go:11)	MOVQ	BP, 64(SP)
	0x0018 00024 (main.go:11)	LEAQ	64(SP), BP
	0x001d 00029 (main.go:11)	FUNCDATA	$0, gclocals·69c1753bd5f81501d95132d08af04464(SB)
	0x001d 00029 (main.go:11)	FUNCDATA	$1, gclocals·e226d4ae4a7cad8835311c6a4683c14f(SB)
	0x001d 00029 (main.go:12)	MOVQ	$0, ""..autotmp_0+48(SP)
	0x0026 00038 (main.go:12)	MOVQ	$0, ""..autotmp_0+56(SP)
	0x002f 00047 (main.go:12)	LEAQ	type.string(SB), AX
	0x0036 00054 (main.go:12)	MOVQ	AX, ""..autotmp_0+48(SP)
	0x003b 00059 (main.go:12)	LEAQ	"".statictmp_0(SB), AX
	0x0042 00066 (main.go:12)	MOVQ	AX, ""..autotmp_0+56(SP)
	0x0047 00071 (main.go:12)	LEAQ	""..autotmp_0+48(SP), AX
	0x004c 00076 (main.go:12)	MOVQ	AX, (SP)
	0x0050 00080 (main.go:12)	MOVQ	$1, 8(SP)
	0x0059 00089 (main.go:12)	MOVQ	$1, 16(SP)
	0x0062 00098 (main.go:12)	PCDATA	$0, $1
	0x0062 00098 (main.go:12)	CALL	fmt.Println(SB)
	0x0067 00103 (main.go:13)	MOVQ	64(SP), BP
	0x006c 00108 (main.go:13)	ADDQ	$72, SP
	0x0070 00112 (main.go:13)	RET
	0x0071 00113 (main.go:13)	NOP
	0x0071 00113 (main.go:11)	PCDATA	$0, $-1
	0x0071 00113 (main.go:11)	CALL	runtime.morestack_noctxt(SB)
	0x0076 00118 (main.go:11)	JMP	0
	0x0000 64 48 8b 0c 25 00 00 00 00 48 3b 61 10 76 62 48  dH..%....H;a.vbH
...
go.string."hello world." SRODATA dupok size=12
	0x0000 68 65 6c 6c 6f 20 77 6f 72 6c 64 2e              hello world.
